...
import { l as i, n as a, s as o } from "./consts-DfWNpZDx.js";
...
function f() {
	h().publicPluginsState === "NOT_INITIALIZED" && (g.push(import("./copilot-log-plugin-DX5ek7Vx.js")), g.push(import("./copilot-info-plugin-Dlrh0qrX.js")), g.push(import("./copilot-features-plugin-Cj7cdHf8.js")), g.push(import("./copilot-feedback-plugin-L1bJ52JZ.js")), g.push(import("./copilot-settings-panel-tbYm61-j.js")), g.push(import("./copilot-impersonator-plugin-IrV3XYyx.js")), g.push(import("./copilot-development-setup-user-guide-CupLQHN9.js")), g.push(import("./copilot-vaadin-versions-DCZYAD2T.js")), v = !0, h().setPublicPluginsState("IMPORTED"));
}
function p() {
...
async function S() {
	return (await import("./copilot-focus-trap-Cy37xCu9.js")).copilotFocusTrap;
}
function C() {
