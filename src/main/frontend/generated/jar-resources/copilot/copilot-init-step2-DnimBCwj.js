...
import { $ as r, C as i, D as a, J as o, L as s, M as c, N as l, R as u, at as d, ct as f, et as p, h as m, i as h, n as g, o as _, r as v, t as y, u as b, ut as x, v as ee, x as te, y as ne, z as S } from "./icons-CwakCZgK.js";
import { l as re, o as ie, t as C } from "./consts-DfWNpZDx.js";
import { c as ae, r as oe } from "./dom-utils-BaXcSXMM.js";
import { a as se, o as ce } from "./copilot-tree-impl-B0CS2EcL.js";
import { a as w, c as le, d as ue, i as de, l as T, n as E, o as fe, r as pe, s as me, t as he, u as ge } from "./section-panel-ui-state-hOj_RfX_.js";
import { a as _e, i as D, n as O, r as ve, t as ye } from "./copilot-ui-state-Dc6l_5DA.js";
import { d as be, i as xe, l as Se, n as Ce, t as we, u as Te } from "./copilot-modes-BQioDtQj.js";
import { r as Ee, t as De } from "./stats-CRkPKCLQ.js";
import { a as Oe, c as ke, i as Ae, l as je, n as Me, o as Ne, r as Pe, s as Fe, t as Ie, u as Le } from "./copilot-userinfo-CsyI3-r3.js";
import { t as Re } from "./directive-DWLihZIi.js";
import { d as ze, f as Be } from "./copilot-error-handler-Cbo3Xg2R.js";
import { n as Ve, t as He } from "./copilot-stored-machine-state-D6qB_Peh.js";
import { n as Ue, r as We, t as Ge } from "./copilot-notification-CCNJdNg4.js";
import { n as Ke, t as k } from "./early-project-state-LGwavSyI.js";
import { i as qe, o as Je, s as Ye } from "./copilot-development-setup-user-guide-utils-B2gX5xwS.js";
import { n as Xe, t as Ze } from "./track-active-mode-event-DkX0nsC6.js";
import { n as Qe, r as $e, t as et } from "./lit-renderer-fa_B9boC.js";
import { n as tt, r as nt, t as rt } from "./copy-to-clipboard-4Y12mBRr.js";
...
var at, ot, st, ct, lt, ut = t((() => {
	...
	de(), me(), he(), v(), tt(), Ct(), g(), ze(), ve(), ae(), re(), d(), fe(), wt = class extends pe {
		constructor(...e) {
			super(...e), this.panelHeaderUpdated = 0, this.openPanels = [], this.windowResizeListener = async () => {
		...
		connectedCallback() {
			super.connectedCallback(), window.addEventListener("resize", this.windowResizeListener), this.reaction(() => O.operationInProgress, () => {
				Array.from(this.querySelectorAll("vaadin-dialog[panel-container]")).forEach((e) => {
					...
					requestAnimationFrame(() => {
						e.toggleAttribute("hiding-while-drag-and-drop", O.operationInProgress === ye.DragAndDrop && !t && !this.hasDropTarget(e));
					});
				});
			...
			}), this.reaction(() => [E.panels, E.getOpenPanelTags().size], () => {
				this.openPanels = E.panels.filter((e) => E.isOpenedPanel(e.tag));
			}, { fireImmediately: !0 }), this.reaction(() => E.panelStackingOrder, () => {
				this.promoteOpenPanels();
			}, { fireImmediately: !0 });
		}
		...
		render() {
			return b`
      ${nt(this.openPanels, (e) => e.tag, (e) => b`<vaadin-dialog
            draggable
            modeless
            id="${e.tag}-dialog"
            waits-positioning
            ...
            @opened-changed="${(t) => {
				...
				n && (E.panelStackingOrder.includes(e.tag) || E.moveStackingOrderToTop(e.tag), (r.querySelector(e.tag)?.requestLayoutUpdate() ?? Promise.resolve()).finally(() => {
					setTimeout(() => {
    ...
    `;
		...
		promoteOpenPanels() {
			this.getOpenPanelContainerDialogs().forEach((e) => {
				let t = e._overlayElement;
				t && typeof t.hidePopover == "function" && typeof t.showPopover == "function" && (t.hidePopover(), t.showPopover());
			});
		}
	...
	}, w([T()], wt.prototype, "panelHeaderUpdated", void 0), w([T()], wt.prototype, "openPanels", void 0), wt = w([ue("copilot-panel-manager")], wt);
})), Et, Dt = t((() => {
...
var Mt, Nt = t((() => {
	de(), me(), ve(), v(), tt(), Ue(), i(), g(), p(), _e(), fe(), Mt = class extends pe {
		createRenderRoot() {
			return this;
		}
		connectedCallback() {
...
function Ft() {
	Ce().default || (Lt.clear(), Lt(), Pe());
}
var It, Lt, Rt = t((() => {
	if (_e(), ve(), It = /* @__PURE__ */ e(Ne(), 1), Ue(), p(), Oe(), Ke(), Ye(), De(), xe(), i(), Lt = (0, It.default)(async () => {
		await Ae();
	...
	ee(() => {
		...
		e.addStateChangeListener && typeof e.addStateChangeListener == "function" ? e.addStateChangeListener((e, t) => {
			e === "loading" && t === "connected" && !Ce().default && Ft();
		...
		k.setSpringSecurityEnabled(e.detail.springSecurityEnabled), k.setSpringJpaDataEnabled(e.detail.springJpaDataEnabled), k.setSpringJpaDatasourceInitialization(e.detail.springJpaDatasourceInitialization), k.setSupportsHilla(e.detail.supportsHilla), k.setSpringApplication(e.detail.springApplication), k.setUrlPrefix(e.detail.urlPrefix), k.setServerVersions(e.detail.serverVersions), k.setJdkInfo(e.detail.jdkInfo), k.setLanguageCapabilities(e.detail.languageCapabilities), qe() === "success" && Ee("hotswap-active", { value: Je() }), e.preventDefault();
	}), D.on("copilot-project-languages", (e) => {
		k.setProjectLanguages(e.detail.projectLanguages), e.preventDefault();
	...
	me(), v(), Ct(), g(), xe(), fe(), zt = class extends h {
		constructor(...e) {
			super(...e), this.rememberChoice = !1, this.opened = !1, this.handleESC = (e) => {
				Ce().appInteractable || !this.opened || (e.key === "Escape" && this.sendEvent("cancel"), e.preventDefault(), e.stopPropagation());
			};
		}
		createRenderRoot() {
			return this;
	...
	_e(), p(), v(), i(), ve(), g(), Ue(), D.on("copilot-project-compilation-error", (e) => {
		if (e.detail.error) {
			let t;
...
var sr, cr, lr, ur, dr, fr, pr, mr, hr, gr, B, _r, vr, yr, br, V, H, U, W, G, xr, Sr, K, Cr, wr, q, Tr, Er, Dr, J, Or, kr, Ar, jr, Y, Mr, Nr, Pr, Fr, Ir, Lr, Rr, zr, Br, Vr, X, Hr, Ur, Wr, Gr, Kr, qr, Jr, Yr, Xr, Zr, Qr, $r, ei, ti, ni, ri, Z, ii, ai, oi, si, ci, li, ui, di, fi, pi = t((() => {
	...
	me(), de(), ve(), v(), he(), tt(), g(), pi(), xe(), Te(), Ie(), ce(), Ci(), He(), Ze(), fe(), Ei = (wi = class extends pe {
		constructor(...e) {
		...
		connectedCallback() {
			super.connectedCallback(), this.popover = "manual", this.setPlayModeIconProgress(1), this.modeRadioButtonItems = Object.entries(we).map(([e, t]) => ({
				value: e,
				label: t.label,
      ...
      <div class="flex" id="common-mode-panel-icon-container">
        ...
        <vaadin-popover
          @opened-changed="${(e) => {
				this.expandModeHandler.devToolsPopoverOpenClosedChanged(e.detail.value), e.detail.value && !this.devToolsDataLoaded && (this.devToolsDataLoading = !0, import("./copilot-devtools-B3EJQgu1.js").then(() => {
					Se(), E.restorePanelsFromStorage(), be(), Me(), this.devToolsDataLoading = !1, this.devToolsDataLoaded = !0;
				}));
			}}"
          position="top"
          for="devtools-button"
...
var Fi = t((() => {
	...
	v(), me(), ve(), de(), Ke(), De(), Ct(), g(), fe(), Ii = class extends pe {
		constructor(...e) {
  ...
  `, this.tryAcquireLicense = () => {
	...
	Da = /* @__PURE__ */ e(Ea(), 1), He(), Ue(), p(), s(), re(), i(), v(), ve(), Oa = (e) => Da.default.valid(e) ?? Da.default.valid(Da.default.coerce(e)), window.Vaadin.copilot.eventbus.on("serverInfo", (e) => {
...
//#endregion
t((() => {
	Tt(), g(), At(), Te(), Nt(), Pt(), Rt(), Bt(), Wt(), Kt(), un(), pn(), Di(), Fi(), Li(), ka(), _e(), D.on("copilot-java-after-update", (e) => {
