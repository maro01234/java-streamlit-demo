...
import { c as b, h as x, l as S, m as C, s as w, u as T } from "./dom-utils-BaXcSXMM.js";
import { a as E, i as D } from "./copilot-ui-state-Dc6l_5DA.js";
import { i as O, o as k, r as A } from "./copilot-error-handler-Cbo3Xg2R.js";
...
var Q, $, te = e((() => {
	s(), J(), l(), b(), k(), c(), j(), _(), E(), Q = /* @__PURE__ */ new WeakMap(), $ = class {
		constructor() {
			this.root = null, this.nodeUuidNodeMapFlat = /* @__PURE__ */ new Map(), this.aborted = !1, this._hasFlowComponent = !1, this.flowNodesInSource = {}, this.flowNodeLanguages = {}, this.flowCustomComponentData = {}, this.hillaCustomComponentData = {}, this.componentDragDropApiInfosMap = {}, this.waitForHillaCustomComponentResponseData = () => new Promise((e) => {
				let t = setTimeout(() => {
		...
		async isInitializedInProjectSources(e) {
			...
			if (!this.flowNodesInSource[i]) {
				...
				e.error && O("Failed to get component source info", e.error), e.suggestRestart && M({
					...
					delay: 3e4
				}), this.flowCustomComponentData[i] = e.customComponentResponse, this.flowNodesInSource[i] = new Set(e.nodeIdsInProject), this.flowNodeLanguages[i] = e.nodeSourceLanguages ?? {}, this.componentDragDropApiInfosMap[i] = e.dragDropApiInfos;
			}
		...
		generateNodeFromFlow(e, t) {
			...
			let i = t?.children.length ?? 0, a = this.flowCustomComponentData, o = this.componentDragDropApiInfosMap, s = this.flowNodeLanguages;
			return {
				node: n,
				get sourceLanguage() {
					return s[n.uiId]?.[n.nodeId];
				},
				parent: t,
				element: e,
				depth: t && t.depth + 1 || 0,
